...
# Test solvate ionize     #
###########################
# Example of a simple solvation + ionization using NAMD.
#
...
set molname modelo3pxg_all_test1

mol new ${molname}.psf
mol addfile ${molname}.pdb

# Determine center of mass and store the coordinates
...
# Determine which water molecules need to be deleted
...
# For loop to delete those waters
